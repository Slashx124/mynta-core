...
class TestRavenCli(RavenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `mynta-cli getinfo`")
        ...
        self.log.info("Compare responses from `mynta-cli -getinfo` and the RPCs data is retrieved from.")
