...
Also test that nodes that send unsupported service bits to myntad are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if myntad ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
