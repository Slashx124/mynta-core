...
# TestNode: A peer we use to send messages to myntad, and store responses.
...
class CompactBlocksTest(RavenTestFramework):
    ...
    # This test actually causes myntad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that myntad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for myntad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # myntad will not send blocktxn responses for blocks whose height is
