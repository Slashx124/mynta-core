...
#ifndef MYNTA_VALIDATION_H
#define MYNTA_VALIDATION_H
...
bool CheckBlock(const CBlock& block, CValidationState& state, const CChainParams& chainparams, bool fCheckPOW = true, bool fCheckMerkleRoot = true, bool fDBCheck = false);
